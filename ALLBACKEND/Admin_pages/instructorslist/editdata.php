        ...
        <form action="edit_delete.php" method="POST">
            ...
            <table class="table table-danger text-center">
                    ...
                    <tr>
                        ...
                        <td>
                              <input type="text" name="cntc" class="form-control" value="<?php echo $cntc; ?>" placeholder="Contact #" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="form-group">
                ...
                <?php endif; ?>
                    <a href="instructorslist.php"><button type="button" class="btn btn-danger">Cancel</button></a>
            </div>
            </center>
        </form>
        </div>
