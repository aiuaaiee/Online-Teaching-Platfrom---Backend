            ...
            <table class="table table-responsive">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="addappli.php?confirm=<?php echo $row['id'];?>"
                                class="btn btn-info" name="confirm">Confirm</a>
                        </td>
                        <td>
                            <a href="remappli.php?delete=<?php echo $row['id'];?>"
