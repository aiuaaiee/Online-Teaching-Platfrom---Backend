...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2022 at 05:14 AM
...
INSERT INTO `teachregs` (`id`, `fname`, `mname`, `lname`, `email`, `cntc`, `password`, `tl`, `res`, `socmed`, `pwe`, `about`, `skill`, `subject`, `status`) VALUES
(24, 'John Paul asdasdasd', 'A', 'Nofuente', 'jpanofuente@gmail.com', 9123456789, 'qqqqqq', '', '', '', '', '', '', '', 'Pending');
